...
COUNTRIES: dict[str, dict[str, str]] = {
    ...
    # Россия — база для сравнения (ТЗ §3.1, Фаза 2). НЕ входит в сбор
    # по умолчанию: объём на порядок больше, и это единственное место,
    # где реально проверяется нарезка по окнам дат.
    "ru": {"area_name": "Россия"},
}

# Что собирается ежедневно без явного указания --country
DEFAULT_COUNTRIES = ("kz", "uz", "kg")
