...
# ФИО физлица в названии работодателя.
#
# Первая версия считала ФИО любые два слова с заглавных — и давала 116
# «имён», среди которых полно компаний вроде «Аква Строй». Надёжный
# признак в русских и казахских именах — отчество, а не заглавные буквы.
PATRONYMIC = r"(?:[оеи]вич|[оеи]вна|[оеи]вна|ұлы|улы|қызы|кызы|кизи|оглы|о[гғ]лы)"
PERSON_EMPLOYER = re.compile(
    # 1. Явное отчество: «Мусаева Улпаш Исаевна», «Асан Серикулы»
    rf"\b[А-ЯЁ][а-яёА-ЯЁ]+\s+[А-ЯЁ][а-яёА-ЯЁ]*{PATRONYMIC}\b|"
    rf"\b[А-ЯЁ][а-яёА-ЯЁ]*{PATRONYMIC}\b\s+[А-ЯЁ][а-яёА-ЯЁ]+|"
    # 2. Явный статус физлица: «ИП Иванов И.И.», «ИП Петрова»
    r"\b(?:ИП|ЖК|индивидуальный\s+предприниматель)\s+[А-ЯЁ][а-яёА-ЯЁ]{2,}|"
